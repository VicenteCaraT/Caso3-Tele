...
"${SCRIPT_DIR}/metabase-setup.sh" "${FE_URL}" mysql-service "${DB_PASS}" "${ADMIN_EMAIL}" "${ADMIN_PASS}"

echo
echo "==> DESPLIEGUE COMPLETO: ${FE_URL}"
echo "    MySQL: gam.mobility = ${COUNT} filas | app DB: metabase_db"
echo "    Admin: ${ADMIN_EMAIL}"
echo "    Dashboards: 'Google Mobility - Dashboard' y 'Google Mobility - Dashboard Filtros'"